<template>
  <div>
    <span @click="showModal = true">terms and conditions</span>
    <div v-if="showModal" class="modal">
      <div class="modal-content">
        ...
        <p>
        The TTM associates “TTM” is committed to respecting and protecting the privacy of our constituents. This privacy policy has been compiled to better serve those who are concerned with how their ‘Personally Identifiable Information’ (PII) is being used online. PII, as described in privacy law and information security, is information that can be used on its own or with other information to identify, contact, or locate a single person, or to identify an individual in context. Furthermore, TTM is committed to acting in compliance with current data protection legislation including the European Union’s General Data Protection Regulation (EU) 2016/ 679 (GDPR). Please read our privacy policy carefully to get a clear understanding of how we collect, use, protect or otherwise handle your Personally Identifiable Information in accordance with our website.
        </p>
         <h4>What information we collect?</h4>
         <p>Information relating to your use of our Site. When visiting our sites, we automatically collect related session data. We also collect information from the URLs from which you linked to our Site. Collecting such information may involve logging the IP address, operating system and browser software used by each user of the Site. We may be able to determine from an IP address a user’s Internet Service Provider and the geographic location of his or her point of connectivity. We also use (or may use) cookies and web beacons when you visit our Site. For more information on our use of cookies and web beacons, please refer to our Cookie Policy. 
          Personally Identifiable Information provided directly by you or via third parties. We collect Personally Identifiable Information that you provide to us when you register for an account, update or change information for your account, purchase products or Services, complete a survey, sign-up for email updates, participate in our public forums, send us email messages, and/or participate in Content Offerings or other Services on our Site. We may use the Personally Identifiable Information that you provide to respond to your questions, provide you the specific Content Offering and/or Services you select, send you updates about Content Offerings or other TTM events, and send you email messages about Site maintenance or updates.
          Finally, when registering on our site, as appropriate, you may be asked to enter your name, email address, mailing address, phone number, Company Name or other details to help you with your experience.
         </p>
         <h4>When do we collect information?</h4>
         <p>We collect information from you when you register on our site, subscribe to a newsletter, fill out a form or enter information on our site. We also collect users’ contact information when making a purchase from our website for our online courses or certifications. This contact information (such as name and email address) and financial information (such as account or credit card number). TTM uses contact information from the order form to send orders to its customers. Contact information is also used to get in touch with customers when necessary.</p>
        ...
        <ul>
          <li>We are committed to ensure that we provide the security of processing and the ongoing confidentiality, integrity, availability, and resilience of systems and services, as such relate to personal data that we hold, in order to prevent accidental or unlawful destruction, loss, alteration, or unauthorized disclosure or access.</li>
          <li>Where we have given you (TTM lms system) username and/or password which enables you to access certain parts of our websites, or use our products and services, you are responsible for keeping the username and password confidential. You should not share these details with anyone.</li>
          <li>We do not use vulnerability scanning and/or scanning to PCI standards.</li>
          <li>We use regular Malware Scanning.</li>
        </ul>
        <h4>Cookies</h4>
        <p>We use cookies.
        These are small files that a site or its service provider transfers to your computer’s hard drive through your Web browser (if you allow) that enables the site’s or service provider’s systems to recognize your browser and capture and remember certain information. They are also used to help us understand your preferences based on previous or current site activity, which enables us to provide you with improved services. We also use cookies to help us compile aggregate data about site traffic and site interaction so that we can offer better site experiences and tools in the future.
        </p>
        <p>How TTM Associates uses cookies</p>
        <p>When you use and access the Site, we may place a number of cookies files in your web browser.</p>
        <p>We use cookies to:</p>
        <ul>
          <li>Understand and save user’s preferences for future visits.</li>
          <li>Compile aggregate data about site traffic and site interactions in order to offer better site experiences and tools in the future. We may also use trusted third-party services that track this information on our behalf.</li>
          <li>To recognise you when you return to the Site. This enables us to personalise our content for you, greet you by name, and remember your preferences when visiting our website, platforms or apps</li>
        </ul>
        ...
        <p>Please see the <a href="" style="color: red;">PayPal Privacy Policy</a> for more details.</p>
        <h4>Contacting Us</h4>
        <p>If there are any questions regarding this privacy policy, you may contact us using the information below:</p>
        <p>Email: info@ttmassociates.com</p>
        <p>Contact Us Form: <a href="" style="color: red;"> https://www.ttmassociates.com/contact/</a></p>
        <div style="display: flex; justify-content: end;">
        <button @click="showModal = false" style="cursor: pointer; border-radius: 5px; background-color: rgb(158, 17, 22); color: white; padding: 8px; border: none;">close</button>
          </div>
